...
public final class DefaultData implements MutableData {
    ...
    // jiang yong 2016-06-17 for localOptimization
	Object object = null;

	public DefaultData(int type, Object object, int partitionHash) {
		this.type = type;
		this.object = ((HazelcastObject) object).copy();
		this.partitionHash = partitionHash;
	}
	
	public Object getObject() {
		return ((HazelcastObject) object).copy();
	}
