...
class StreamSerializerAdapter implements SerializerAdapter {
    ...
    public Data toData(Object object, int partitionHash) throws IOException {
    	...
    	//jiang yong 2015-06-17 for localOptimization
    	if (serializer.getTypeId() == SerializationConstants.EASYCACHE_HAZELCAST_OBJECT_ID + 1) {
    		return new DefaultData(serializer.getTypeId(), object, partitionHash);
    	}
    	//jiang yong done
    	else {
    ...
    public Object toObject(Data data) throws IOException {
    	//jiang yong 2015-06-17 for localOptimization
    	if (serializer.getTypeId() == SerializationConstants.EASYCACHE_HAZELCAST_OBJECT_ID + 1) {
    		return ((DefaultData)data).getObject();
    	}
    	//jiang yong done
