...
public final class SerializationConstants {
    ...
    //---------------------------------------------------------------
    // jiang yong 2016-06-17 for HazelcastObject serialization
    // if add other serializers for easycache, id should begin with -10001 by decrease
    // EASYCACHE SERIALIZERS
    public static final int EASYCACHE_HAZELCAST_OBJECT_ID = -10000;
